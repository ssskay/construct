...
- **829 test files** total: 356 at `tests/` top level + 473 in subdirectories.
- **Layers:** unit 562, functional 219, visual 12, live-provider 2, integration 34.
- **Functional layer:** 219 file(s) under `tests/functional/` or `*.functional.test.mjs`. End-to-end checks spawn the real binary or import real modules in an isolated tmpdir.
...
### 5. Functional layer (219 tests, 219 files)
